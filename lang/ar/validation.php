...
return [
    ...
    'attributes'           => [
        ...
        'value'                    => 'قيمة',
        'year'                     => 'السنة',
        'selected_unit'         => 'الكلية',
        'unit_type_id'             => __('unit type'),
        'unit_id'                  => __('The Unit'),
        'department_id'            => __('The Department'),
        'selected_department' => 'القسم الاكاديمي',
        'department_code'          => __('Department Code'),
        'question_type'            => __('Question Type'),
        'selected_major'           => 'التخصص',
        'major_id'                 => __('The Major'),

        'id_number'                => 'رقم الهوية',
        'work_number'              => 'الرقم الوظيفي',
        'identity_type_id'         => 'نوع الهوية',
        'selected_id_type'         => 'نوع الهوية',
        ...
        'registration_end_date'    => 'تاريخ نهاية التسجيل',
        'selected_user_type'       => 'من داخل الكلية؟',
        'lecture_date'             => 'تاريخ المحاضرة',
        'lecture_time'             => 'وقت المحاضرة',
        'lecture_duration'         => 'مدة المحاضرة',
        'selected_attendance'      => 'طبيعة التدريب',
        'attendance_type_id'      => 'طبيعة التدريب',
        'attendance_percent'       => __('Attendance Percent'),
        'phone_number'             => 'رقم الجوال',
        'registration_start_date'  => 'تاريخ بداية التسجيل',
        'registration_end_date'    => 'تاريخ نهاية التسجيل',
        'lecture_start_time'       => 'وقت بداية المحاضرة',


        'curriculum_code'            => 'رمز المقرر',
        'curriculum_name'              => 'اسم المقرر',
        'curriculum_description'       => 'وصف المقرر',
        ...
        'study_days'                => 'أيام التدريب',
        'answers'         => 'الإجابات',
        'min_trainees_count' => 'الحد الادنى للمتدربين',
        'max_trainees_count' => 'الحد الاعلى للمتدربين',
        'max_in_person_trainees_count' => 'الحد الاعلى للحضور',
        'attendance_gender' => 'نوع الحضور',
        'target_gender' => 'الجنس المستهدف',
        'target_category_id' => 'اتاحة التسجيل',
        'target_staffs' => 'الفئات المستهدفة',

        'eventTypeName' => 'أسم الحدث',
        'eventForm.calendar_event_type_id' => 'نوع الحدث',
        'eventForm.start_date' => 'تاريخ بداية الحدث',
        'eventForm.end_date' => 'تاريخ نهاية الحدث',
        'eventForm.can_create_lectures' => 'يمكن إنشاء محاضرات',
        'location_id' => 'الموقع',
        'certificateNumber' => 'رقم الشهادة',
        'searchField' => 'البحث'
    ],
    'custom' => [
            'max_in_person_trainees_count' => [
                'required_if' => 'حقل الحد الاعلى للحضور مطلوب.',
            ],
            'attendance_gender' => [
                'required_if' => 'حقل نوع الحضور مطلوب.'
            ]
        ],
];
