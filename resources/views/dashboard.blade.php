<x-layouts.app :title="__('Dashboard')">
    {{-- <div class="flex flex-wrap h-full w-full flex-1 max:md:flex-col gap-4 rounded-3xl p-lg-8"> --}}
    <div class="grid grid-cols-1 lg:grid-cols-4 h-full w-full gap-4 rounded-3xl p-lg-8">
        ...
        <x-card class="col-span-2 h-116 p-0!">
            <livewire:users.show>
        </x-card>
    </div>
</x-layouts.app>
